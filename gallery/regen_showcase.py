...
CAMERA_BY_SECTION = {
    ...
    # Lifecycle — mostly phone with occasional dedicated cameras for milestones
    "pregnancy":       "Fujifilm X-T5",
    "newborn":         "iPhone 15 Pro",
    "baby-milestones": "iPhone 15 Pro",
    "toddler":         "Sony A7 IV",
    "kids-school":     "iPhone 15 Pro",
    "graduation":      "Sony A7 IV",
    "engagement":      "Fujifilm X-T5",
    "wedding":         "Nikon Z8",
    "honeymoon":       "Sony A7 IV",
    "baby-shower":     "iPhone 15 Pro",
    "gender-reveal":   "iPhone 15 Pro",
    "housewarming":    "iPhone 15 Pro",
    "retirement":      "iPhone 15 Pro",
    "anniversaries":   "Fujifilm X-T5",

    # Holidays — mostly phone
    "valentines":      "iPhone 15 Pro",
    "easter":          "iPhone 15 Pro",
    "mothers-day":     "iPhone 15 Pro",
    "fathers-day":     "iPhone 15 Pro",
    "halloween":       "iPhone 15 Pro",
    "thanksgiving":    "Sony A7 IV",
    "christmas-eve":   "Fujifilm X-T5",
    "christmas-morning":"Sony A7 IV",
    "christmas-dinner":"iPhone 15 Pro",
    "new-years-eve":   "iPhone 15 Pro",
    "diwali":          "iPhone 15 Pro",
    "ramadan-eid":     "iPhone 15 Pro",
    "chinese-new-year":"iPhone 15 Pro",
    "st-patricks":     "iPhone 15 Pro",
    "4th-of-july":     "iPhone 15 Pro",
    "mardi-gras":      "Sony A7 IV",
    "oktoberfest":     "iPhone 15 Pro",

    # Daily life — mostly phone
    "home-projects":   "iPhone 15 Pro",
    "cooking":         "Fujifilm X-T5",
    "dinner-parties":  "Fujifilm X-T5",
    "home-life":       "iPhone 15 Pro",
    "hobbies-creative":"Fujifilm X-T5",
    "games":           "iPhone 15 Pro",
    "pets-life":       "iPhone 15 Pro",
    "family-daily":    "iPhone 15 Pro",
    "shopping":        "iPhone 15 Pro",
    "errands":         "iPhone 15 Pro",
    "gardening":       "Fujifilm X-T5",
    "house-cleaning":  "iPhone 15 Pro",

    # Work + culture + wellness
    "work-life":       "iPhone 15 Pro",
    "business-events": "Sony A7 IV",
    "meetings":        "iPhone 15 Pro",
    "travel-work":     "iPhone 15 Pro",
    "fitness-active":  "Sony A7 IV",
    "wellness":        "iPhone 15 Pro",
    "beauty-fashion":  "iPhone 15 Pro",
    "music-arts":      "iPhone 15 Pro",
    "cultural":        "Sony A7 IV",
    "travel-lite":     "Sony A7 IV",
    "religious-spiritual":"Fujifilm X-T5",
    "volunteering":    "iPhone 15 Pro",
}

# Aspect classification by filename convention — set from prompt files.
# Landscape unless the section is dominated by portraits or square shots.
ASPECTS_BY_SECTION = {
    # Legacy sections
    ...
    # NEW — batches 13/14/15/16 default to landscape unless overridden per-entry
    "pregnancy":       "landscape",
    "newborn":         "landscape",
    "baby-milestones": "landscape",
    "toddler":         "landscape",
    "kids-school":     "landscape",
    "graduation":      "landscape",
    "engagement":      "landscape",
    "wedding":         "landscape",
    "honeymoon":       "landscape",
    "baby-shower":     "landscape",
    "gender-reveal":   "landscape",
    "housewarming":    "landscape",
    "retirement":      "landscape",
    "anniversaries":   "landscape",
    "valentines":      "landscape",
    "easter":          "landscape",
    "mothers-day":     "landscape",
    "fathers-day":     "landscape",
    "halloween":       "landscape",
    "thanksgiving":    "landscape",
    "christmas-eve":   "landscape",
    "christmas-morning":"landscape",
    "christmas-dinner":"landscape",
    "new-years-eve":   "landscape",
    "diwali":          "landscape",
    "ramadan-eid":     "landscape",
    "chinese-new-year":"landscape",
    "st-patricks":     "landscape",
    "4th-of-july":     "landscape",
    "mardi-gras":      "landscape",
    "oktoberfest":     "landscape",
    "home-projects":   "landscape",
    "cooking":         "landscape",
    "dinner-parties":  "landscape",
    "home-life":       "landscape",
    "hobbies-creative":"landscape",
    "games":           "landscape",
    "pets-life":       "landscape",
    "family-daily":    "landscape",
    "shopping":        "landscape",
    "errands":         "landscape",
    "gardening":       "landscape",
    "house-cleaning":  "landscape",
    "work-life":       "landscape",
    "business-events": "landscape",
    "meetings":        "landscape",
    "travel-work":     "landscape",
    "fitness-active":  "landscape",
    "wellness":        "landscape",
    "beauty-fashion":  "landscape",
    "music-arts":      "landscape",
    "cultural":        "landscape",
    "travel-lite":     "landscape",
...
SECTIONS = [
    ...
    # ============ LIFECYCLE & MILESTONES (batch-13) ============
    ("pregnancy",        "Pregnancy",          "Bump portraits, ultrasounds, nesting — the months before."),
    ("newborn",          "Newborn",            "Hospital arrival, first-hold, first-bath — the earliest days."),
    ("baby-milestones",  "Baby milestones",    "First steps, first tooth, first solid, first birthday — the year of firsts."),
    ("toddler",          "Toddler years",      "Running the park, playgroups, muddy play — motion + laughter."),
    ("kids-school",      "School days",        "First day of school, plays, sports days — the school-year calendar."),
    ("graduation",       "Graduation",         "Kindergarten hats, high-school gowns, doctoral hooding — every level."),
    ("engagement",       "Engagements",        "Proposals, ring macros — the yes."),
    ("wedding",          "Weddings",           "Ceremony, reception, first dance, cake cut — the day."),
    ("honeymoon",        "Honeymoons",         "Beaches, mountains, cityscapes — the after."),
    ("baby-shower",      "Baby showers",       "Bumps, gifts, family gathering — the welcome."),
    ("gender-reveal",    "Gender reveals",     "Reveal moments — the pop of colour."),
    ("housewarming",     "Housewarmings",      "New keys, first meal, wine-and-friends — the settling in."),
    ("retirement",       "Retirement",         "Parties, farewells, first-day-home — the transition."),
    ("anniversaries",    "Anniversaries",      "First, silver, golden — years together, marked."),

    # ============ HOLIDAYS UNIVERSAL (batch-14) ============
    ("valentines",       "Valentine's",        "Roses, notes, candlelit dinners, gift exchanges."),
    ("easter",           "Easter",             "Egg hunts, family lunches, chocolate close-ups."),
    ("mothers-day",      "Mother's Day",       "Breakfast in bed, flowers, phone calls home."),
    ("fathers-day",      "Father's Day",       "Grills, gifts, hugs — the dad-day rhythm."),
    ("halloween",        "Halloween",          "Pumpkin carving, costumes, trick-or-treat, decorated houses."),
    ("thanksgiving",     "Thanksgiving",       "Turkey tables, family gatherings, football, pie."),
    ("christmas-eve",    "Christmas Eve",      "Decorating trees, candlelight services."),
    ("christmas-morning","Christmas morning",  "Kids opening gifts, tree lights, pyjamas breakfast, family portrait."),
    ("christmas-dinner", "Christmas dinner",   "The spread, the toast, the dessert."),
    ("new-years-eve",    "New Year's Eve",     "Fireworks, midnight kisses, friends' parties."),
    ("diwali",           "Diwali",             "Candles, rangoli, family in traditional dress."),
    ("ramadan-eid",      "Ramadan & Eid",      "Iftar tables, prayer at the mosque."),
    ("chinese-new-year", "Chinese New Year",   "Red lanterns, dumpling making."),
    ("st-patricks",      "St. Patrick's Day",  "Pub scenes, green parades."),
    ("4th-of-july",      "Independence Day",   "Backyard BBQs, flags, fireworks from the lawn."),
    ("mardi-gras",       "Mardi Gras",         "Parades, costumes, king cakes."),
    ("oktoberfest",      "Oktoberfest",        "Beer halls, dirndls, brass bands."),

    # ============ DAILY LIFE + HOME + COOKING (batch-15) ============
    ("home-projects",    "Home projects",      "Renovations, painting, furniture assembly, garden builds."),
    ("cooking",          "Cooking",            "Everyday dinners, Sunday roasts, brunch, baking, cocktail hours."),
    ("dinner-parties",   "Dinner parties",     "Formal + casual — the friends-around-the-table row."),
    ("home-life",        "Home life",          "Morning coffee, evening reading, WFH, laundry, cat-on-lap."),
    ("hobbies-creative", "Hobbies & creative", "Knitting, painting, journaling, LEGO, jigsaws, reading."),
    ("games",            "Games",              "Board games, video games, family tablet moments."),
    ("pets-life",        "Pets daily",         "Adoption day, vet, grooming, playtime, cuddles."),
    ("family-daily",     "Family rhythm",      "School run, homework, bedtime stories, breakfast, weekend cartoons."),
    ("shopping",         "Shopping",           "Grocery, farmers markets, boutiques."),
    ("errands",          "Errands",            "Post office, dry cleaner — the everyday chores."),
    ("gardening",        "Gardening",          "Planting, harvesting, herb gardens, terrace plants."),
    ("house-cleaning",   "Cleaning + tidying", "Organising drawers, spring cleans — proud-of-the-space shots."),

    # ============ WORK + CULTURE + WELLNESS (batch-16) ============
    ("work-life",        "Work life",          "Office desks, WFH setups, café work, coworking, video calls."),
    ("business-events",  "Business events",    "Conferences, workshops, launches, team photos, awards."),
    ("meetings",         "Meetings",           "Boardrooms, small teams, one-on-ones."),
    ("travel-work",      "Work travel",        "Airport lounges, business hotels, work dinners."),
    ("fitness-active",   "Fitness active",     "Running, gym, yoga, cycling, swimming, hiking, climbing, marathons."),
    ("wellness",         "Wellness",           "Spas, massages, meditation, saunas, sound baths."),
    ("beauty-fashion",   "Beauty & fashion",   "Salons, vanities, outfit flatlays, jewellery try-ons."),
    ("music-arts",       "Music & arts",       "Concerts, festivals, karaoke, piano at home, band practice."),
    ("cultural",         "Cultural",           "Museums, galleries, theatre, opera, comedy."),
    ("travel-lite",      "Travel — lite",      "City breaks, road trips, camping, glamping, cruises, safaris, backpacking."),
    ("religious-spiritual","Faith & spirit",   "Church, temple, meditation retreats."),
    ("volunteering",     "Volunteering",       "Community service, charity runs."),
